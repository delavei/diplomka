...
\begin{description}
\item[percpu\_usage] - obsahuje pole hodnôt, kde každá reprezentuje čas strávený na danom jadre procesora
\item[total\_usage] - predstavuje sumárnu hodnotu času, ktorý strávil kontajner na všetkých jadrách spolu
\item[usage\_in\_usermode] - predstavuje procesorový čas (pre všetka jadrá), v ktorom došlo k vykonávaniu aplikačného kódu
\item[usage\_in\_kernelmode] - predstavuje procesorový čas (pre všetka jadrá), v ktorom došlo k volaniu kódu jadra operačného systému
\end{description}
...
\begin{description}
\item[cpu\_time] - suma času, ktorý strávil virtuálny stroj na procesore hosťujúceho počítača \cite{libvirt-cpu}
\item[user\_time] - procesorový čas v nanosekundách, v ktorom došlo k vykonávaniu aplikačného kódu
\item[system\_time] - procesorový čas v nanosekundách, v ktorom došlo k volaniu kódu jadra operačného systému
\end{description}
