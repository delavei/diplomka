...
keywords = {cloud, monitorovanie, metriky, MetaCentrum, heterogénna infraštruktúra, Hadoop, PBS Professional, Docker, libvirt},
gender = {m},
type = {mgr},
faculty = {fi},
...
\thesislong{abstract}{
    Práca sa zaoberá zberom metrík o vyťažení zdrojov v heterogénnej infraštruktúre MetaCentra. Popisuje koncepty poskytovania
    výpočetných zdrojov v rámci heterogénnej infraštruktúry. Venuje sa všeobecným problémom monitorovnia, akými sú proces zberu 
    metrík, ukladanie a správa uložených hodnôt.
    Identifikuje metriky a popisné dáta relevantné pre vyťaženie zdrojov. 
	Cieľom práce je návrh monitorovacieho riešenia pre zadanú infraštruktúru a popis jeho implementácie a testovania.}
\thesislong{thanks}{
    Touto cestou by som sa rád poďakoval vedúcemu diplomovej práce Mgr. Miroslavovi
Rudovi za umožnenie vypracovania tohto zadania ako aj za jeho čas
a odborné vedenie práce. Špeciálna vďaka patrí Mgr. Borisovi Parákovi za
jeho trpezlivosť, názory a cenné rady pri vypracovávaní. Osobitné poďakovanie
patrí aj mojej rodine, priateľom a Nicol za podporu.}
...
ktorých uzly sú rozložené po celom svete (napr. BOINC\footnotemark\footnotetext{Berkeley Open Infrastructure for Network Computing - https://boinc.berkeley.edu/}). Jednotlivé subjekty na komunikáciu využívajú bežné
...
aj jednotlivé uzly rozmiestnené po celej republike. Virtuálne stroje sú poskytované prostredníctvom linuxového modulu jadra \textit{KVM}\footnotemark\footnotetext{Kernel Virtualization Module}\cite{kvm}. 
...
Koordináciu gridových výpočtov zabezpečuje plánovač \textit{PBS Professional}\footnotemark\footnotetext{http://www.pbsworks.com/}. V nasledujúcich sekciách sa podrobnejšie venujem popisu jednotlivých softvérov.
...
Po konzultácií so školiteľom bola jedna z platforiem v zadaní Torque nahradená platformou PBS Professional\footnotemark\footnotetext{Portable Batch System}\cite{pbs_pro}. PBS Professional je odvodený od 
...
dát o mnohých ďalších službách, ako je monitorovanie databáz, odozvy serverov, webových služieb, výkonu JVM\footnotemark\footnotetext{Java Virtual Machine}, sledovanie logov. Podporuje monitorovanie virtualizačnej platformy VMWare. 
...
\item[containersReserved] - počet rezervovaných kontajnerov.
\item[containersPending] - počet kontajnerov čakajúcich na umiestnenie.
