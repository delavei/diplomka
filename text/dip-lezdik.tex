...
Momentálne MetaCentrum poskytuje všetky formy využitia dostupného výkonu. Jednotlivým prístupom zodpovedá konkrétne softvérové riešenie, ktorému sa budem venovať v nasledujúcich častiach.
...
Aj keď sa daná úloha vypočítava na viacerých uzloch cloudu a rozličnými postupmi, vlastník by mal mať prehľad ako je reálne celá infraštruktúra vyťažovaná.
